...
<head>
    ...
    <link rel="stylesheet" href="../styleCSS/painel.css" />
</head>
...
<body>
    <div class="login-container">
        <h2>devchallenges</h2>
        <h1>Login</h1>
        <form method="post" action="../handler/login_db.php">
            <div class="input">
                <label for="email">
        ...
        <div class="social-media">
            ...
            <span>Don’t have an account yet? <a href="./painel.php">Register</a></span>
        </section>
